...
def pedir_contrato():
    ...
    si=True
    while si:
        contrato = input("Ingrese el número de contrato (formato 123-4567): ")
        
        # Validación con expresión regular
        if re.match(patron, contrato):
            si=False
        else:
            print("Formato incorrecto. Debe ser ddd-dddd (ej. 234-5241).")
    return contrato
...
(5) 8,05 ---> 25,99 euros.\n'''
    while bucle:
        print(f"\nPotencias disponibles: {(tarifas_fijas)}")
        ...
        if potencia <= 5 and potencia > 0: 
            ...
            print("\nPotencia no válida. Elija una de la tabla seleccionando el numero como 1, 2, 3, 4 o 5\n")
    return potencia
...
def main():
    ...
    print("\n" + "*"*40)
    print("RESUMEN TOTAL DE LA JORNADA LABORAL")
    print("*"*40)
